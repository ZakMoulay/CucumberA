...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
    ...
    public void user_enters_and_and_verifying_the_for_the_combinations
            (String username, String password, String errorMessagExpected) {
        ...
        click(loginPage.loginButton);
        String errorMessageActual = loginPage.errorMeassageField.getText();
        Assert.assertEquals("value does not match", errorMessageActual, errorMessagExpected);
